...
LOAD_MODEL = False
model_name = '/home/shashank/Desktop/GitHub/Reinforcement-Learning-for-Quadruped-Robots/Aliengo/checkpoints/AlienGo_best_-105.764_1085440.dat'
def make_env():
        ...
        if train_epoch % TEST_EPOCHS == 0:
            ...
            if best_reward is None or best_reward < test_reward:
                if best_reward is not None:
                    ...
                    name = "%s_best_%+.3f_%d.dat" % (args.name,
